...
template <typename S, typename A, typename O> class POMDPModel {
  public:
    ...
    POMDPModel(const States &states, const Actions &actions, const Observations &observations, double discount = 0.95)
        : states_(states), actions_(actions), observations_(observations), discount_(discount),
