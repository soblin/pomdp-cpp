...
class SimpleLightDark : public POMDPModel<int, int, double> {
  public:
    SimpleLightDark(const States &states, const Actions &actions, const Observations &observations,
...
int main() {
    ...
    auto simple_lightdark = SimpleLightDark(states, actions, std::vector<double>({}), 0.95);
